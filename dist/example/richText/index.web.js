...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/@flyme/weex-flymeui/example/richText/index"] = factory();
	else
		root["npm/@flyme/weex-flymeui/example/richText/index"] = factory();
})(this, function() {
...
Component.options.__file = "/mnt/WORK/workspace/creator/creator/weex-flymeui/example/richText/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7bd43f62", Component.options)
  } else {
    hotAPI.reload("data-v-7bd43f62", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("334c5e73", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/.0.28.7@css-loader/index.js?sourceMap!../../node_modules/.11.3.3@vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7bd43f62\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/.11.3.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/.0.28.7@css-loader/index.js?sourceMap!../../node_modules/.11.3.3@vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-7bd43f62\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/.11.3.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
    components: { Title: _title2.default, Category: _category2.default, FmRichText: _index.FmRichText, FmSpecialRichText: _index.FmSpecialRichText },
    data: function data() {
        return {
            configList: [{
                type: 'icon',
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }), _vm._v(" "), _c('fm-rich-text', {
    staticClass: "special-rich",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "config-list": _vm.configList
    },
    on: {
      "linkBeClick": _vm.linkBeClick
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
  ...
  }), _vm._v(" "), _c('fm-special-rich-text', {
    staticClass: "special-rich",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "config-list": _vm.specialConfigList
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "config-list": _vm.specialConfigList1
    }
  })], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-7bd43f62", module.exports)
  }
}
