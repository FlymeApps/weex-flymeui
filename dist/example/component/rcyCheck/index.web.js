...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/component/rcyCheck/index"] = factory();
	else
		root["npm/weex-flymeui/example/component/rcyCheck/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/component/rcyCheck/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3da84d10", Component.options)
  } else {
    hotAPI.reload("data-v-3da84d10", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("2275689c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-3da84d10\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-3da84d10\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  components: { FmRcyCheck: _index.FmRcyCheck },
  data: function data() {
    return {
      dataSource: [{ type: 'check-cell', checking: false, checked: false, disabled: false, area: '珠海', itemId: 1 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '广州', itemId: 2 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '湛江', itemId: 3 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '深圳', itemId: 4 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '汕头', itemId: 5 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '潮州', itemId: 6 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '佛山', itemId: 7 }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '中山', itemId: 8 }],
      checkAll: false,
      count: 0
    };
  },
  ...
  methods: {
    ...
    loadData: function loadData() {
      var moreData = [{ type: 'check-cell', checking: false, checked: false, disabled: false, area: '江门', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '阳江', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '云浮', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '揭阳', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '河源', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '韶关', itemId: Math.random().toString(36).substr(2) }];
      this.dataSource = this.dataSource.concat(moreData);
      // modal.alert({ message: this.dataSource })
      if (this.$refs.list !== undefined) {
        this.$refs.list.appendData(moreData);
    ...
    toggalAll: function toggalAll() {
      this.checkAll = !this.checkAll;
      this.$refs.list.toggleAll(this.checkAll);
    },
    valueChange: function valueChange(newData) {
      this.dataSource = newData;
      this.calculate();
    },
    checkFinish: function checkFinish(e) {
      this.$refs.list.removeData(e.indexs);
    },
    cellBeClick: function cellBeClick(e) {
      modal.alert({ message: e.value });
    },
    calculate: function calculate() {
      ...
      try {
        for (var _iterator = dataSource.values()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  mounted: function mounted() {
    var moreData = [{ type: 'check-cell', checking: false, checked: false, disabled: false, area: '江门', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '阳江', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '云浮', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '揭阳', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '河源', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '韶关', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '云浮', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '揭阳', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '河源', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '韶关', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '云浮', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '揭阳', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '河源', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '韶关', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '云浮', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '揭阳', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '河源', itemId: Math.random().toString(36).substr(2) }, { type: 'check-cell', checking: false, checked: false, disabled: false, area: '韶关', itemId: Math.random().toString(36).substr(2) }];
    this.$refs.list.appendData(moreData);
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("已选择 " + _vm._s(_vm.count) + " 个")]), _vm._v(" "), _c('text', {
    staticClass: "headerText",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    on: {
  ...
  }, [_vm._v(_vm._s(_vm.checkAll ? '全不选' : '全选'))])]), _vm._v(" "), _c('fm-rcy-check', {
    ref: "list",
    staticClass: "rcy-check",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
    ...
    on: {
      "fmRcyCheckValueChange": _vm.valueChange,
      "fmRcyCheckFinish": _vm.checkFinish,
      "fmRcyCheckCellBeClick": _vm.cellBeClick
    }
  })], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3da84d10", module.exports)
  }
}
