...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/component/multiCheck/index"] = factory();
	else
		root["npm/weex-flymeui/example/component/multiCheck/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/component/multiCheck/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-59c0c572", Component.options)
  } else {
    hotAPI.reload("data-v-59c0c572", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("33c9ca16", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-59c0c572\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-59c0c572\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = _defineProperty({
  components: { Title: _title2.default, Category: _category2.default, FmMultiCheckGroup: _index.FmMultiCheckGroup, FmMultiCheckCell: _index.FmMultiCheckCell },
  methods: {
    click: function click() {
      modal.toast({ message: '点击了安装' });
    }
  ...
  selecting: function selecting(value) {
    this.checkData = value;
  },
  toggalAll: function toggalAll() {
    if (this.checkData.length < 9) {
      this.checkData = ['第一条数据', '第二条数据', '第三条数据', '第四条数据', '第五条数据', '第六条数据', '第七条数据', '第八条数据', '第九条数据'];
    } else {
      this.checkData = [];
    }
  },
  beClick: function beClick(e) {
    modal.toast({ message: 'childClick' });
  },
  longpress: function longpress(e) {
    this.$refs.multiSelect.active();
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', [_c('div', {
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("已选择 " + _vm._s(_vm.checkData.length) + " 个")]), _vm._v(" "), _c('text', {
    staticClass: "headerText",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    on: {
  ...
  }, [_vm._v("全选")])]), _vm._v(" "), _c('fm-multi-check-group', {
    ref: "multiSelect",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
    ...
    on: {
      "fmMultiCheckGroupSelected": _vm.selecting
    }
  }, _vm._l((_vm.dataSource), function(item, index) {
    return _c('fm-multi-check-cell', {
      key: index,
      staticStyle: _vm.$processStyle(undefined),
      style: (_vm.$processStyle(undefined)),
      attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-59c0c572", module.exports)
  }
}
