...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/component/input/index"] = factory();
	else
		root["npm/weex-flymeui/example/component/input/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/component/input/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fab92ab0", Component.options)
  } else {
    hotAPI.reload("data-v-fab92ab0", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("1076b0e4", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-fab92ab0\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-fab92ab0\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.mzui-demo[data-v-fab92ab0] {\n    position: absolute;\n    top: 0;\n    right: 0;\n    left: 0;\n    bottom: 0;\n    background-color: #ffffff;\n}\n.title[data-v-fab92ab0] {\n    margin-top: 60px;\n    margin-bottom: 30px;\n    color: #aaaaaa;\n}\n.contaniner[data-v-fab92ab0] {\n    padding: 30px;\n}\n", "", {"version":3,"sources":["/Users/suen/Documents/develop/project/weex-flymeui/example/component/input/index.vue?7d16847d"],"names":[],"mappings":";AA4BA;IACA,mBAAA;IACA,OAAA;IACA,SAAA;IACA,QAAA;IACA,UAAA;IACA,0BAAA;CACA;AACA;IACA,iBAAA;IACA,oBAAA;IACA,eAAA;CACA;AACA;IACA,cAAA;CACA","file":"index.vue","sourcesContent":["<template>\n    <div class=\"mzui-demo\">\n        <scroller class=\"scroller\">\n            <title link=\"http://design.flyme.cn/book/book.html?bookId=59ef0a54a5a0a6738061aeeb&doc=59effc7867e2274f086396b6\"></title>\n            <category title=\"默认的输入框\"></category>\n                 \n            <fm-input :nightMode=true  placeholder=\"默认的输入框\" :autofocus=true  />\n            <category title=\"密文模式\"></category>\n            <fm-input type=\"password\" placeholder=\"password\" :nightMode=true />\n            <category title=\"日期输入\"></category>\n            <fm-input type=\"time\" placeholder=\"time\" />\n            <category title=\"修改 placeholder\"></category>\n            <fm-input type=\"text\" placeholder=\"placeholder\" :nightMode=true />\n            <category title=\"带初始值的输入框\"></category>\n            <fm-input value=\"value\" />\n            <category title=\"限制最大输入长度\"></category>\n            <fm-input maxlength=\"20\" placeholder=\"maxlength:20\" />\n            <category title=\"输入校验\"></category>\n            <fm-input type=\"text\" :inputPattern=\"/^[0-9]{1,20}$/\" inputErrorMessage=\"请输入数字\" />\n            <category title=\"多行Textarea\"></category>\n            <textarea class=\"textarea\" rows=5 @input=\"oninput\" @change=\"onchange\" @focus=\"onfocus\" @blur=\"onblur\"></textarea>\n            <category title=\"多行Textarea\"></category>\n            <textarea placeholder=\"请输入手机/QQ/邮箱，便于我们与你沟通\" rows=\"8\"></textarea>\n        </scroller>\n    </div>\n</template>\n\n<style scoped>\n    .mzui-demo {\n        position: absolute;\n        top: 0;\n        right: 0;\n        left: 0;\n        bottom: 0;\n        background-color: #ffffff;\n    }\n    .title {\n        margin-top: 60px;\n        margin-bottom: 30px;\n        color: #aaaaaa;\n    }\n    .contaniner {\n        padding: 30px;\n    }\n</style>\n\n<script>\nimport { FmInput } from '../../../index';\nimport Title from '../../_mods/title.vue';\nimport Category from '../../_mods/category.vue';\nimport { setTitle } from '../../_mods/set-nav';\n\nconst modal = weex.requireModule('modal');\n\nexport default {\n    components: { Title, Category, FmInput }\n}\n</script>\n"],"sourceRoot":""}]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "link": "http://design.flyme.cn/book/book.html?bookId=59ef0a54a5a0a6738061aeeb&doc=59effc7867e2274f086396b6"
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "placeholder": "请输入手机/QQ/邮箱，便于我们与你沟通",
      "rows": "8"
    }
  })], 1)], 1)
},staticRenderFns: []}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-fab92ab0", module.exports)
  }
}
