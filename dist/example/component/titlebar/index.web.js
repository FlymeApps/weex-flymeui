...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/component/titlebar/index"] = factory();
	else
		root["npm/weex-flymeui/example/component/titlebar/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/component/titlebar/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-475eae1a", Component.options)
  } else {
    hotAPI.reload("data-v-475eae1a", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("610f4da8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-475eae1a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-475eae1a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  components: { Title: _title2.default, Category: _category2.default, FmTitlebar: _index.FmTitlebar, FmTag: _index.FmTag },
  data: function data() {
    return {
      btns1: [{
        type: 'icon',
  ...
  methods: {
    rightBtnClick: function rightBtnClick(e) {
      modal.toast({ message: e });
    }
  }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "link": "https://yanjiie.github.io/weex-flymeui/#/packages/fm-titlebar/"
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    ...
    on: {
      "fmTitlebarRightBtnClicked": _vm.rightBtnClick
    }
  }), _vm._v(" "), _c('fm-titlebar', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "title": "这是一段很长很长的 title 这是一段很长很长的 title 这是一段很长很长的 title",
      "statusbar": false
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    ...
    on: {
      "fmTitlebarRightBtnClick": _vm.rightBtnClick
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-475eae1a", module.exports)
  }
}
