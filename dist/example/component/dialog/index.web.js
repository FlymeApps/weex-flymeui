...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/component/dialog/index"] = factory();
	else
		root["npm/weex-flymeui/example/component/dialog/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/component/dialog/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-15e3db00", Component.options)
  } else {
    hotAPI.reload("data-v-15e3db00", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("117e8903", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-15e3db00\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-15e3db00\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports.default = {
  components: { Title: _title2.default, Category: _category2.default, FmButton: _index.FmButton, FmDialog: _index.FmDialog, FmDialogBtn: _index.FmDialogBtn, FmCheckListGroup: _index.FmCheckListGroup, FmCheckbox: _index.FmCheckbox, FmInput: _index.FmInput },
  data: function data() {
    return {
      show: false,
      checkListShow: false,
  ...
  methods: {
    ...
    dialogOverlayClick: function dialogOverlayClick() {
      this.show = false;
      modal.toast({ message: '点击了蒙层' });
    },
    checkListClick: function checkListClick(btn) {
      if (btn.type === 'cancel') {
        modal.toast({ message: '点击了取消' });
      } else if (btn.type === 'confirm') {
        modal.toast({ message: '选择了: ' + this.checkList.toString() });
    ...
    checkListOverlayClick: function checkListOverlayClick() {
      this.checkListShow = false;
      modal.toast({ message: '点击了蒙层' });
    },
    groupChecked: function groupChecked(arr) {
      this.checkList = arr;
    },
    inputClick: function inputClick(btn) {
      if (btn.type === 'cancel') {
        modal.toast({ message: '取消' });
      } else if (btn.type === 'confirm') {
        modal.toast({ message: '输入的是: ' + this.inputText });
    ...
    inputOverlayClick: function inputOverlayClick() {
      this.inputShow = false;
      modal.toast({ message: '点击了蒙层' });
    },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "link": "http://apps.flyme.cn/docs/book.html?bookId=59ef0a54a5a0a6738061aeeb&doc=5a3390d167e2277e77dcf943"
    }
  }), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
  ...
  })], 1), _vm._v(" "), _c('fm-dialog', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "show": _vm.checkListShow,
      "title": "选择语言",
      "can-auto-close": true,
      "overlayOpacity": 0.1
    },
    on: {
      "fmDialogBtnClicked": _vm.checkListClick,
      "fmDialogOverlayClicked": _vm.checkListOverlayClick
    }
  }, [_c('fm-check-list-group', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "slot": "content"
    ...
    on: {
      "fmCheckListGroupChecked": _vm.groupChecked
    },
    slot: "content"
  }, [_c('fm-checkbox', [_vm._v("简体中文")]), _vm._v(" "), _c('fm-checkbox', [_vm._v("繁体中文")]), _vm._v(" "), _c('fm-checkbox', [_vm._v("英文")])], 1)], 1), _vm._v(" "), _c('fm-dialog', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "show": _vm.inputShow,
    ...
    on: {
      "fmDialogBtnClicked": _vm.inputClick,
      "fmDialogOverlayClicked": _vm.inputOverlayClick
    }
  }, [_c('fm-input', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    ...
    on: {
      "fmDialogBtnClicked": _vm.btnClick,
      "fmDialogOverlayClicked": _vm.dialogOverlayClick
    }
  })], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-15e3db00", module.exports)
  }
}
