...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/@flyme/weex-flymeui/example/tabView/index"] = factory();
	else
		root["npm/@flyme/weex-flymeui/example/tabView/index"] = factory();
})(this, function() {
...
Component.options.__file = "/mnt/WORK/workspace/creator/creator/weex-flymeui/example/tabView/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6f02c0ca", Component.options)
  } else {
    hotAPI.reload("data-v-6f02c0ca", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("4a2dca86", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/.0.28.7@css-loader/index.js?sourceMap!../../node_modules/.11.3.3@vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6f02c0ca\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/.11.3.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/.0.28.7@css-loader/index.js?sourceMap!../../node_modules/.11.3.3@vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6f02c0ca\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/.11.3.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.mzui-demo[data-v-6f02c0ca] {\n\tposition: absolute;\n\ttop: 0;\n\tright: 0;\n\tleft: 0;\n\tbottom: 0;\n\tbackground-color: #fff;\n}\n.item[data-v-6f02c0ca] {\n\tfont-size: 18px;\n\ttext-align: center;\n\tcolor: #fff;\n\theight: 360px;\n\tmargin-top: 2px;\n\tpadding-top: 50px;\n}\n.item1[data-v-6f02c0ca] {\n\tbackground-color: #54ae56;\n}\n.item2[data-v-6f02c0ca] {\n\tbackground-color: #f34949;\n}\n.item3[data-v-6f02c0ca] {\n\tbackground-color: #508aeb;\n}\n", "", {"version":3,"sources":["/mnt/WORK/workspace/creator/creator/weex-flymeui/example/tabView/index.vue?080385ad"],"names":[],"mappings":";AAcA;CACA,mBAAA;CACA,OAAA;CACA,SAAA;CACA,QAAA;CACA,UAAA;CACA,uBAAA;CACA;AAEA;CACA,gBAAA;CACA,mBAAA;CACA,YAAA;CACA,cAAA;CACA,gBAAA;CACA,kBAAA;CACA;AACA;CACA,0BAAA;CACA;AACA;CACA,0BAAA;CACA;AACA;CACA,0BAAA;CACA","file":"index.vue","sourcesContent":["<template>\n  \t<div class=\"mzui-demo\">\n\t\t<title title=\"fm-tab-view\"></title>\n\t\t<category title=\"TabView\"></category>\n\t\t<fm-tab-view :items=\"items\" @slidend=\"end\">\n\t\t\t<text class=\"item item1\" slot=\"item1\">我是tab1</text>\n\t\t\t<text class=\"item item2\" slot=\"item3\">我是333</text>\n\t\t\t<text class=\"item item3\" slot=\"item2\">我是222</text>\n\t\t</fm-tab-view>\n\t</div>\n</template>\n\n<style scoped>\n\n.mzui-demo {\n\tposition: absolute;\n\ttop: 0;\n\tright: 0;\n\tleft: 0;\n\tbottom: 0;\n\tbackground-color: #fff;\n}\n\n.item {\n\tfont-size: 18px;\n\ttext-align: center;\n\tcolor: #fff;\n\theight: 360px;\n\tmargin-top: 2px;\n\tpadding-top: 50px;\n}\n.item1 {\n\tbackground-color: #54ae56;\n}\n.item2 {\n\tbackground-color: #f34949;\n}\n.item3 {\n\tbackground-color: #508aeb;\n}\n</style>\n\n<script>\nimport { FmTabView } from '../../index';\nimport Title from '../_mods/title.vue';\nimport Category from '../_mods/category.vue';\nimport { setTitle } from '../_mods/set-nav';\n\nconst modal = weex.requireModule('modal');\n\nexport default {\n    components: { Title, Category, FmTabView },\n\tdata () {\n\t\treturn {\n\t\t\titems: [{\n\t\t\t\tname: 'item1',\n\t\t\t\ttext: 'Tab1'\n\t\t\t}, {\n\t\t\t\tname: 'item2',\n\t\t\t\ttext: 'Tab2'\n\t\t\t}, {\n\t\t\t\tname: 'item3',\n\t\t\t\ttext: 'Tab3'\n\t\t\t}]\n\t\t}\n\t},\n\tmethods: {\n\t\tend (data) {\n\t\t\tmodal.toast({message: data})\n\t\t}\n\t}\n}\n</script>\n"],"sourceRoot":""}]);
...
exports.default = {
	components: { Title: _title2.default, Category: _category2.default, FmTabView: _index.FmTabView },
	data: function data() {
		return {
			items: [{
				name: 'item1',
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-6f02c0ca", module.exports)
  }
}
