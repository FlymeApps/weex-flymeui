...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/@flyme/weex-flymeui/example/text/index"] = factory();
	else
		root["npm/@flyme/weex-flymeui/example/text/index"] = factory();
})(this, function() {
...
Component.options.__file = "/mnt/WORK/workspace/creator/creator/weex-flymeui/example/text/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-224c39d3", Component.options)
  } else {
    hotAPI.reload("data-v-224c39d3", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("51f8c46d", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/.0.28.7@css-loader/index.js?sourceMap!../../node_modules/.11.3.3@vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-224c39d3\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/.11.3.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../node_modules/.0.28.7@css-loader/index.js?sourceMap!../../node_modules/.11.3.3@vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-224c39d3\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/.11.3.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
// module
exports.push([module.i, "\n.mzui-demo[data-v-224c39d3] {\n  position: absolute;\n  top: 0;\n  right: 0;\n  left: 0;\n  bottom: 0;\n  background-color: #fff;\n}\n.scroller[data-v-224c39d3] {\n  flex: 1;\n}\n.text[data-v-224c39d3] {\n    margin-bottom: 20px;\n}\n.container[data-v-224c39d3] {\n    padding: 20px;\n    padding-bottom: 0px;\n}\n", "", {"version":3,"sources":["/mnt/WORK/workspace/creator/creator/weex-flymeui/example/text/index.vue?5a38f6f2"],"names":[],"mappings":";AAqCA;EACA,mBAAA;EACA,OAAA;EACA,SAAA;EACA,QAAA;EACA,UAAA;EACA,uBAAA;CACA;AAEA;EACA,QAAA;CACA;AAEA;IACA,oBAAA;CACA;AAEA;IACA,cAAA;IACA,oBAAA;CACA","file":"index.vue","sourcesContent":["<template>\n  <div class=\"mzui-demo\">\n    <scroller class=\"scroller\">\n      <title title=\"fm-text\"></title>\n      <category title=\"基本样式\"></category>\n        <div class=\"container\">\n            <FmText class=\"text\" textValue=\"nomal基本样式\" />\n            <FmText class=\"text\" medium textValue=\"medium样式 ( Android不支持 )\"/>\n            <FmText class=\"text\" bold textValue=\"bold样式\"/>\n            <FmText class=\"text\" light textValue=\"light样式\"/>\n            <FmText class=\"text\" :textStyle=\"{color: '#198ded'}\" textValue=\"自定义样式\"/>\n        </div>\n      <category title=\"标题文本\"></category>\n        <div class=\"container\">\n            <FmText class=\"text\" title textValue=\"标题\"/>\n        </div>\n      <category title=\"加粗标题\"></category>\n        <div class=\"container\">\n            <FmText class=\"text\" title bold textValue=\"标题\"/>\n        </div>\n      <category title=\"小号段落\"></category>\n        <div class=\"container\">\n            <FmText small textValue=\"Weex 是一套简单易用的跨平台开发方案，能以 web 的开发体验构建高性能、可扩展的 native 应用，为了做到这些，Weex 与 Vue 合作，使用 Vue 作为上层框架，并遵循 W3C 标准实现了统一的 JSEngine 和 DOM API，这样一来，你甚至可以使用其他框架驱动 Weex，打造三端一致的 native 应用。\" />\n        </div>\n      <category title=\"大号段落\"></category>\n        <div class=\"container\">\n            <FmText large textValue=\"Weex 是一套简单易用的跨平台开发方案，能以 web 的开发体验构建高性能、可扩展的 native 应用，为了做到这些，Weex 与 Vue 合作，使用 Vue 作为上层框架，并遵循 W3C 标准实现了统一的 JSEngine 和 DOM API，这样一来，你甚至可以使用其他框架驱动 Weex，打造三端一致的 native 应用。\" />\n        </div>\n      <category title=\"超大号段落\"></category>\n        <div class=\"container\">\n            <FmText huge textValue=\"Weex 是一套简单易用的跨平台开发方案，能以 web 的开发体验构建高性能、可扩展的 native 应用，为了做到这些，Weex 与 Vue 合作，使用 Vue 作为上层框架，并遵循 W3C 标准实现了统一的 JSEngine 和 DOM API，这样一来，你甚至可以使用其他框架驱动 Weex，打造三端一致的 native 应用。\" />\n        </div>\n    </scroller>\n  </div>\n</template>\n\n<style scoped>\n  .mzui-demo {\n    position: absolute;\n    top: 0;\n    right: 0;\n    left: 0;\n    bottom: 0;\n    background-color: #fff;\n  }\n  \n  .scroller {\n    flex: 1;\n  }\n\n  .text {\n      margin-bottom: 20px;\n  }\n\n  .container {\n      padding: 20px;\n      padding-bottom: 0px;\n  }\n</style>\n\n<script>\nimport { FmText } from '../../index';\nimport Title from '../_mods/title.vue';\nimport Category from '../_mods/category.vue';\nimport { setTitle } from '../_mods/set-nav';\n\nconst modal = weex.requireModule('modal');\n\nexport default {\n    components: { Title, Category, FmText },\n}\n</script>\n"],"sourceRoot":""}]);
...
exports.default = {
    components: { Title: _title2.default, Category: _category2.default, FmText: _index.FmText }
};
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    attrs: {
      "small": "",
      "textValue": "Weex 是一套简单易用的跨平台开发方案，能以 web 的开发体验构建高性能、可扩展的 native 应用，为了做到这些，Weex 与 Vue 合作，使用 Vue 作为上层框架，并遵循 W3C 标准实现了统一的 JSEngine 和 DOM API，这样一来，你甚至可以使用其他框架驱动 Weex，打造三端一致的 native 应用。"
    }
  })], 1), _vm._v(" "), _c('category', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-224c39d3", module.exports)
  }
}
