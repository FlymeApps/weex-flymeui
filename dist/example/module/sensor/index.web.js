...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/module/sensor/index"] = factory();
	else
		root["npm/weex-flymeui/example/module/sensor/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/index/components/cell.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("1deb5433", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-bac18b2a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./cell.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-bac18b2a\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./cell.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-bac18b2a", module.exports)
  }
}
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/module/sensor/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ba14e3a6", Component.options)
  } else {
    hotAPI.reload("data-v-ba14e3a6", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("05d3ff6e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-ba14e3a6\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-ba14e3a6\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var sensor = weex.requireModule('sensor'); //
//
//
//
//
...
exports.default = {
    components: { FmText: _index.FmText, FmIcon: _index.FmIcon, DCell: _cell2.default, Title: _title2.default },
    data: function data() {
        return {
            orientation: {
                x: 0,
    ...
    methods: {
        ...
        demo1: function demo1() {
            ...
            // 单次获取当前瞬间方向
            sensor.getCurrentOrientation(function (res) {
                res.result === 'success' ? _this.orientation = JSON.parse(res.data) : modal.toast({ message: res });
            });
        },
        demo2: function demo2() {
            ...
            if (this.orientationID) return;
            modal.toast({ message: '开始监听' });
            sensor.watchCurrentOrientation(function (res) {
                res.result === 'success' ? (_this2.orientationID = JSON.parse(res.data).watchId) && (_this2.orientation = JSON.parse(res.data)) : modal.toast({ message: res });
            });
        },
        ...
        demo4: function demo4() {
            ...
            // 单次获取当前瞬间加速度
            sensor.getCurrentAccelerometer(function (res) {
                res.result === 'success' ? _this3.accelerometer = JSON.parse(res.data) : modal.toast({ message: res });
            });
        },
        demo5: function demo5() {
            ...
            if (this.accelerometerID) return;
            modal.toast({ message: '开始监听' });
            sensor.watchCurrentAccelerometer(function (res) {
                res.result === 'success' ? (_this4.accelerometerID = JSON.parse(res.data).watchId) && (_this4.accelerometer = JSON.parse(res.data)) : modal.toast({ message: res });
            });
        },
        ...
        demo7: function demo7() {
            ...
            // 单次获取当前瞬间陀螺仪数据
            sensor.getCurrentGyroscope(function (res) {
                res.result === 'success' ? _this5.gyroscope = JSON.parse(res.data) : modal.toast({ message: res });
            });
        },
        demo8: function demo8() {
            ...
            if (this.gyroscopeID) return;
            modal.toast({ message: '开始监听' });
            sensor.watchCurrentGyroscope(function (res) {
                res.result === 'success' ? (_this6.gyroscopeID = JSON.parse(res.data).watchId) && (_this6.gyroscope = JSON.parse(res.data)) : modal.toast({ message: res });
            });
        },
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "link": "http://design.flyme.cn/book/book.html?bookId=59df3445a5a0a611eee9f119&doc=59e0773867e2271c7fc46b40"
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "list",
    staticStyle: _vm.$processStyle(undefined),
  ...
  }, [_vm._v("方向传感器")]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("当前方向:")]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("x: " + _vm._s(_vm.orientation.x))]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("y: " + _vm._s(_vm.orientation.y))]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("z: " + _vm._s(_vm.orientation.z))])], 1), _vm._v(" "), _c('d-cell', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "title": "单次获取当前瞬间方向",
      "subTitle": "方向传感器 -- 单次获取当前瞬间方向"
    },
    on: {
      "click": _vm.demo1
    }
  ...
  }, [_vm._v("加速度传感器")]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("当前方向:")]), _vm._v(" "), _c('fm-text', {
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("x: " + _vm._s(_vm.accelerometer.x))]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("y: " + _vm._s(_vm.accelerometer.y))]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("z: " + _vm._s(_vm.accelerometer.z))])], 1), _vm._v(" "), _c('d-cell', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "title": "单次获取当前瞬间加速度",
      "subTitle": "加速度传感器 -- 单次获取当前瞬间加速度"
    },
    on: {
      "click": _vm.demo4
    }
  ...
  }, [_vm._v("陀螺仪传感器")]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("当前方向:")]), _vm._v(" "), _c('fm-text', {
    ...
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("x: " + _vm._s(_vm.gyroscope.x))]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("y: " + _vm._s(_vm.gyroscope.y))]), _vm._v(" "), _c('fm-text', {
    staticClass: "data",
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined))
  }, [_vm._v("z: " + _vm._s(_vm.gyroscope.z))])], 1), _vm._v(" "), _c('d-cell', {
    staticStyle: _vm.$processStyle(undefined),
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "title": "单次获取当前瞬间陀螺仪角速度",
      "subTitle": "陀螺仪 -- 单次获取当前瞬间陀螺仪角速度"
    },
    on: {
      "click": _vm.demo7
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-ba14e3a6", module.exports)
  }
}
