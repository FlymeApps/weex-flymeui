...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/module/share/index"] = factory();
	else
		root["npm/weex-flymeui/example/module/share/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/module/share/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-465f1d62", Component.options)
  } else {
    hotAPI.reload("data-v-465f1d62", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("b5239a9e", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-465f1d62\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-465f1d62\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var share = weex.requireModule('share'); //
//
//
//
//
...
exports.default = {
  components: { FmText: _index.FmText, FmIcon: _index.FmIcon, DCell: _cell2.default, Title: _title2.default, FmInput: _index.FmInput, FmButton: _index.FmButton },
  data: function data() {
    return {
      title: 'Flyme Design',
      content: '为你提供最全面的公共规范内容展示，让你方便调用动画参数、设计参数以及控件代码',
  ...
  methods: {
    ...
    shareText: function shareText() {
      ...
      share.shareText(title, content, function (res) {
        modal.toast({ message: res });
      });
    },
    shareImageByUrl: function shareImageByUrl() {
      var imageUrl = this.imageUrl,
          content = this.content;

      share.shareImageByUrl(imageUrl, content, function (res) {
        modal.toast({ message: res });
      });
    },
    shareImageByPath: function shareImageByPath() {
      var imagePath = this.imagePath,
          content = this.content;

      share.shareImageByPath(imagePath, content, function (res) {
        modal.toast({ message: res });
      });
    },
    shareImagesByPath: function shareImagesByPath() {
      var imagesPath = this.imagesPath,
          content = this.content;

      share.shareImagesByPath(imagesPath, content, function (res) {
        modal.toast({ message: res });
      });
    }
  }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "link": "http://design.flyme.cn/book/book.html?bookId=59df3445a5a0a611eee9f119&doc=59df4aa067e2271c7fc46b3a"
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "list",
    staticStyle: _vm.$processStyle(undefined),
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "text": "分享多张图片(Native 路径,最多9张)"
    },
    on: {
      "click": _vm.shareImagesByPath
    }
  })], 1)], 1)
},staticRenderFns: []}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-465f1d62", module.exports)
  }
}
