...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["npm/weex-flymeui/example/module/userinfo/index"] = factory();
	else
		root["npm/weex-flymeui/example/module/userinfo/index"] = factory();
})(this, function() {
...
Component.options.__file = "/Users/suen/Documents/develop/project/weex-flymeui/example/module/userinfo/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] index.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2f8c54ac", Component.options)
  } else {
    hotAPI.reload("data-v-2f8c54ac", Component.options)
  }
})()}
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(2)("334be273", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-2f8c54ac\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-2f8c54ac\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
var userinfo = weex.requireModule('userinfo'); //
//
//
//
//
...
var url = weex.config.bundleUrl.replace(/navigator\/index.native.js/, 'navigatorTest/index.native.js');
...
exports.default = {
    ...
    methods: {
        ...
        demo1: function demo1() {
            // 获取登录状态
            userinfo.getLoginState(function (res) {
                modal.toast({ message: res });
            });
        },
        demo2: function demo2() {
            // 获取token
            userinfo.getUserToken(function (res) {
                modal.toast({ message: res });
            });
        },
        demo3: function demo3() {
            ...
            userinfo.getUserToken(function (res) {
                if (res.result === 'success') {
                    var token = res.data;
                    userinfo.getUserInfo(token, function (res) {
                        modal.toast({ message: res });
                    });
                } else {
                    modal.toast({ message: res });
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: (_vm.$processStyle(undefined)),
    attrs: {
      "link": "http://design.flyme.cn/book/book.html?bookId=59df3445a5a0a611eee9f119&doc=59df4a6267e2271c7fc46b38"
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "list",
    staticStyle: _vm.$processStyle(undefined),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2f8c54ac", module.exports)
  }
}
